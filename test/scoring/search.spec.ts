...
describe('scoring search', () => {
  ...
  describe('returns one bruteforce match given an empty match sequence:', () => {
    const result = mostGuessableMatchSequence(password, [], options)
  ...
  describe('returns match + bruteforce when match covers a prefix of password:', () => {
    ...
    const result = mostGuessableMatchSequence(
      password,
      matches as any,
      options,
      excludeAdditive,
  ...
  describe('chooses lower-guesses match given two matches of the same span:', () => {
    ...
    let result = mostGuessableMatchSequence(
      password,
      matches as any,
      options,
      excludeAdditive,
    ...
    result = mostGuessableMatchSequence(
      password,
      matches as any,
      options,
      excludeAdditive,
